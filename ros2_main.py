...
# 从你的 utils 和 model 目录导入必要的模块
# 你需要确保这些模块的路径相对于 ros2_main.py 是正确的，
# 或者将它们安装为 Python 包，或者调整 sys.path
# 为了简单起见，这里假设它们在 Python 的搜索路径中
# 或者你可以像这样添加路径（不推荐用于生产，最好是ROS包结构）:
# import sys
# import os
...
from utils.motion_tracker import MultiObjectTracker # 假设 MultiObjectTracker, Track, box_iou 在此
...
def main(args=None):
    ...
    parser.add_argument("--model_path", type=str, default="model/yolo11n.pt", help="Path to YOLO model")
